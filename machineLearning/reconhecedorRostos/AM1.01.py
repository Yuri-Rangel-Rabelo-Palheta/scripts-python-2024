...
attributes = pd.read_csv('caminho/da/pasta/list_attr_celeba.csv')
images_path = 'caminho/da/pasta/img_align_celeba/img_align_celeba/'
...
# Configurar o layout para as matrizes de confusão
...
plot_confusion_matrix(axs[0], rf_conf_matrix, 'Random Forest Confusion Matrix')
plot_confusion_matrix(axs[1], svm_conf_matrix, 'SVM Confusion Matrix')
plot_confusion_matrix(axs[2], cnn_conf_matrix, 'CNN Confusion Matrix')
